...
const Process = () => {
    ...
    {
    ai: file(relativePath: {eq: "about/icon-_0001_node.png"}) {
        childImageSharp {
          fluid {
    ...
    xd: file(relativePath: {eq: "about/icon-_0009_xd.png"}) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
    ...
    ae: file(relativePath: {eq: "about/icon-_0010_effects.png"}) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
    ...
    ps: file(relativePath: {eq: "about/icon-_0011_photoshop.png"}) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
    ...
    pr: file(relativePath: {eq: "about/icon-_0011_photoshop.png"}) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
    ...
    blender: file(relativePath: {eq: "about/icon-_0003_blender.png"}) {
        childImageSharp {
          fluid {
            ...GatsbyImageSharpFluid
          }
...
`)
    const ai = data.ai.childImageSharp.fluid
    const xd = data.xd.childImageSharp.fluid
    const ae = data.ae.childImageSharp.fluid
    const ps = data.ps.childImageSharp.fluid
    const pr = data.pr.childImageSharp.fluid
    const blender = data.blender.childImageSharp.fluid
    console.log("ai", ai)
    const Processes = [
        {
            heading: "Design",
                    ...
                    const side2 = <div className="md:w-1/2">
                        <div className="flex items-center justify-center flex-wrap m-auto mt-4 md:mt-0 md:w-4/5">
                            {process.images.map(image => {
                                ...
                                return <div key={Math.random() * 9999}><img src={image.url} alt={image.alt} width={100} /></div>
                            })}
                        </div>
                    </div>
                    return (
                        <div className="container-py" key={Math.random() * Math.random()}>
